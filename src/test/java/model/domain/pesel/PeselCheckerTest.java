...
class PeselCheckerTest {
    ...
    public void modificationDateOfBirth_nonConvertedData_convertedData(String birth, List<String> expectedResult) {
        PeselChecker pc = new PeselChecker();
        List<String> modifiedBirthDate = pc.modificationDateOfBirth(birth);
    ...
    public void isFirstSixNumberCorrect_data_data (String[] pesel, String dateOfBirth, boolean expectedNumber){
        PeselChecker pc = new PeselChecker();
            boolean dateAndPeselCorrectness = pc.isFirstSixNumberCorrect(pesel, dateOfBirth);
